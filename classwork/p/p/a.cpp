...
public:
	Signup(int cmpid = 0, string name = "", int custid = 0, string str = "", int vl = 0, int MBup = 0, int MBdown = 0, int cmpid1 = 0, int custid1 = 0)// : companyid(cmpid), companyname(name), cid(custid), str(str), vl(vl), MBup(MBup), MBdown(MBdown), companyid1(cmpid), cid1(custid) {}
	{
...
int menu(vector<Signup>& sig)
{
	...
	sig = { 1522840, "Jio", 42502, "MOC", 312, 0, 0, 1697783, 42501 };
...
int main()
{
	...
	cout << "welcome " << endl;
	vector<Signup>sig = {22840, "Jio", 42502, "MOC", 312, 0, 0, 1697783, 42501};
	login l;
	menu(sig);
